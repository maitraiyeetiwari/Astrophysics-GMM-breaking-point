...
n_slope = [1,1, 1,0.5, 0.5,0.45,0.9,0.05,0.09,0.7]
...
plt.text(2, 1, 'RCW 49',fontsize=12)
plt.text(14.3, 1, 'first breaking point',fontsize=12)


plt.savefig('rcw49-n-out-in-slope-plot.png',dpi=500,bbox_inches='tight')
#plt.show()